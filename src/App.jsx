...
.bd-head-main{flex:1;min-width:0;display:flex;flex-direction:column;justify-content:center;gap:10px;}
.bd-title{font-family:'Barlow Semi Condensed',sans-serif;font-weight:700;font-size:30px;letter-spacing:.4px;margin:0;line-height:.95;text-transform:uppercase;color:var(--ink);}
.bd-head-right{display:flex;align-items:center;gap:7px;flex-wrap:wrap;}
